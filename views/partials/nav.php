    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            ...
            <button  id="HideMenuButton" 
                 class="hidden inline-flex items-center p-2 text-sm font-medium text-center 
            ...
            <div class="hidden md:block">
                <div class=" <?= $user?? "hidden" ?> ml-4 flex items-center md:ml-6">
                    <a href="/cart" type="button" class="  rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                ...
                <div class=" <?= $user? "hidden" :""?> ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        <div>
                            ...
                            type="button" data-dropdown-toggle="dropdown">Sign in</a>
        ...
        <div class="md:hidden hidden" id="mobile-menu">
            ...
            <div class="border-t border-gray-700 pt-4 pb-3">
                ...
                <div class="mt-3 space-y-1 px-4">
                    <a href="#" class="block rounded-md px-2 py-4 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Your Profile</a>


                    <a href="#" class="block rounded-md px-2 py-4 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Sign out</a>
                </div>
            </div>
        </div>
</nav>
